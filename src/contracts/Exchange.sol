...
contract Exchange{
    ...
    address public feeAccount; // the account that receives excahange fees.
    ...
    // Reverts if Ether sent directly to exhange (Not sure how this works)
    function() external {
        revert();
    }
    ...
    function _trade(uint256 _orderId, address _user, address _tokenGet, uint256 _amountGet, address _tokenGive, uint256 _amountGive) internal{
        ...
        tokens[_tokenGive][_user] = tokens[_tokenGive][msg.sender].add(_amountGive);
